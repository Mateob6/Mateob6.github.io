...
export function MobileNav() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 z-50 flex w-full items-center justify-around border-t border-border bg-surface shadow-[0_-4px_20px_rgba(0,0,0,0.06)] sm:hidden"
        ...
        return (
          <Link
            ...
            className={cn(
              ...
              isActive ? "text-accent" : "text-muted opacity-60 hover:opacity-100",
              item.highlighted && isActive && "rounded-full bg-accent-subtle px-4"
            )}
          >
            {item.icon}
